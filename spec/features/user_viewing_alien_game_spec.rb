...
RSpec.feature 'USER viewing alien game', type: :feature do
  ...
  let!(:game) do [
      FactoryBot.create(:game, created_at: Time.parse('2016.10.09, 13:00'), finished_at: Time.parse('2016.10.09, 13:30'), is_failed: true, current_level: 15, prize: 1000, user: sergey),
      FactoryBot.create(:game, created_at: Time.parse('2016.10.09, 18:00'), current_level: 7, prize: 2000, user: sergey) 
    ]
  end
